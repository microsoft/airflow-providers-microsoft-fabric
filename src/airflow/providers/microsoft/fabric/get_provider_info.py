    ...
    return {
        ...
        "hooks": [
                ...
                "python-modules": [
                    ...
                    "airflow.providers.microsoft.fabric.hooks.run_item.livy"],
            }
        ...
        "operators": [
            {
                ...
                "python-modules": [
                    ...
                    "airflow.providers.microsoft.fabric.operators.run_item.livy"],
            }
        ],
        "extra-links": [
        ...
        "triggers": [
            {
                ...
                "python-modules": [
                    ...
                    "airflow.providers.microsoft.fabric.triggers.run_item.livy"],
            }
        ],
        "plugins": [
            {
